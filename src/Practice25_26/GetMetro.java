...
public class GetMetro {
    ...
    private void branch() throws IOException {
        int k=1;
        String branches ="\"lines\" : [ \n ";
        ...
        branches=branches+"\n]";
        stations=stations+"\n}";
        FileWriter writer = new FileWriter(("F:\\IdeaProjects\\Java_Practices\\src\\Practice25_26\\file.json"));
        writer.write("{\n");
    ...
    public void read() throws IOException {
        ...
        JsonReader reader = new JsonReader(new FileReader("F:\\IdeaProjects\\Java_Practices\\src\\Practice25_26\\file.json"));
